...
$(document).ready(function () {
    ...
    $('#taskTable').on('click', '.cor', function () {
        var obj = new Object();
        obj.name = $(this).parent().parent().children('.tName').text();
        obj.definition = $(this).parent().parent().children('.tDef').text();
        obj.taskDate = $(this).parent().parent().children('.tDate').text();
        obj.typeId = parseInt($(this).parent().parent().children('.tType').children('select').val());
        obj.priorityId = parseInt($(this).parent().parent().children('.tPriority').children('select').val());
        ...
        $.ajax({
            ...
            dataType: 'text',
            data: jsonData,
            success: function (data, ststus, resp) {
                $(this).parent().parent().attr('data-id', resp.taskId);
